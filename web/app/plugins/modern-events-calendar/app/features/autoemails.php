...
class MEC_feature_autoemails extends MEC_base
{
    ...
    public function init()
    {
        ...
        if (!isset($this->settings['auto_emails_module_status']) || !$this->settings['auto_emails_module_status']) return false;

        $this->factory->action('init', [$this, 'register_post_type']);
        $this->factory->action('save_post', [$this, 'save_email'], 10);
    ...
    {
        add_meta_box('mec_email_metabox_details', esc_html__('Details', 'mec'), [$this, 'meta_box_details'], $this->PT, 'normal', 'high');
    }
