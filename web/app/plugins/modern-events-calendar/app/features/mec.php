...
class MEC_feature_mec extends MEC_base
{
    ...
    {
        $sizes = [
            'default' => esc_html__('Default', 'mec'),
            'thumbnail' => esc_html__('Thumbnail', 'mec'),
            'medium' => esc_html__('Medium', 'mec'),
            'medium_large' => esc_html__('Medium Large', 'mec'),
            'large' => esc_html__('Large', 'mec'),
            'full' => esc_html__('Full', 'mec'),
        ];
        ...
        $html = '<div class="' . esc_attr(implode(' ', $classes)) . '"' . $data_attributes . '>
            <label class="mec-col-4" for="mec_skin_' . esc_attr($skin) . '_image_size">' . esc_html__('Image Size', 'mec') . '</label>
