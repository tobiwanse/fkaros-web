        ...
        <div class="mec-skins-options-container">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_list_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and strpos($sk_options_list['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_liquid-large_container">
                    <label class="mec-col-4" for="mec_skin_list_liquid_large_date_format1"><?php esc_html_e('Date Formats', 'mec'); ?></label>
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php esc_html_e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "F d"', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/list-view-skin/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and strpos($sk_options_list['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_liquid-medium_container">
                    <label class="mec-col-4" for="mec_skin_list_liquid_medium_date_format1"><?php esc_html_e('Date Formats', 'mec'); ?></label>
                ...
                <div class="mec-form-row mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and strpos($sk_options_list['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_liquid-small_container">
                    <label class="mec-col-4" for="mec_skin_list_liquid_small_date_format1"><?php esc_html_e('Date Formats', 'mec'); ?></label>
                ...
                <div class="mec-form-row mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and strpos($sk_options_list['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_liquid-minimal_container">
                    <label class="mec-col-4" for="mec_skin_list_liquid_minimal_date_format1"><?php esc_html_e('Date Formats', 'mec'); ?></label>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_grid_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and strpos($sk_options_grid['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_liquid-large_container">
                    <label class="mec-col-4" for="mec_skin_grid_liquid_large_date_format1"><?php esc_html_e('Date Formats', 'mec'); ?></label>
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php esc_html_e('Date Formats', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "F d"', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/grid-view-skin/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                <div class="mec-form-row mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and strpos($sk_options_grid['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_liquid-medium_container">
                    <label class="mec-col-4" for="mec_skin_grid_liquid_medium_date_format1"><?php esc_html_e('Date Formats', 'mec'); ?></label>
                ...
                <div class="mec-form-row mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and strpos($sk_options_grid['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_liquid-small_container">
                    <label class="mec-col-4" for="mec_skin_grid_liquid_small_date_format1"><?php esc_html_e('Date Formats', 'mec'); ?></label>
                ...
                <div class="mec-form-row mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and strpos($sk_options_grid['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_liquid-minimal_container">
                    <label class="mec-col-4" for="mec_skin_grid_liquid_minimal_date_format1"><?php esc_html_e('Date Formats', 'mec'); ?></label>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_yearly_view_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-yearly-view-date-format-container mec-yearly_view-fluent <?php if(isset($sk_options_yearly_view['style']) and $sk_options_yearly_view['style'] != 'fluent') echo 'mec-util-hidden'; ?>" id="mec_skin_yearly_view_date_format_fluent_container">
                    <label class="mec-col-4" for="mec_skin_yearly_view_fluent_date_format1"><?php esc_html_e('Date Formats', 'mec'); ?></label>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_cover_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-cover-date-format-container <?php if(isset($sk_options_cover['style']) and $sk_options_cover['style'] != 'liquid-type1') echo 'mec-util-hidden'; ?>" id="mec_skin_cover_date_format_liquid_container">
                    <label class="mec-col-4" for="mec_skin_cover_date_format_liquid1"><?php esc_html_e('Date Formats', 'mec'); ?></label>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_carousel_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-carousel-date-format-container <?php if(isset($sk_options_carousel['style']) and strpos($sk_options_carousel['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_carousel_date_format_liquid_container">
                    <label class="mec-col-4" for="mec_skin_carousel_liquid_date_format1"><?php esc_html_e('Date Format', 'mec'); ?></label>
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            ...
                            <div class="content"><p><?php esc_attr_e('Default value is d F Y', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/carousel-view-skin/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_slider_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-slider-date-format-container <?php if(isset($sk_options_slider['style']) and strpos($sk_options_slider['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_slider_date_format_liquid_container">
                    <label class="mec-col-4" for="mec_skin_slider_liquid_date_format1"><?php esc_html_e('Date Format', 'mec'); ?></label>
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php esc_html_e('Date Format', 'mec'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is d F Y', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/slider-view-skin/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
